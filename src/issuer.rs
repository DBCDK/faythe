...
async fn init_resolvers(config: &FaytheConfig) -> Result<HashMap<String, TokioAsyncResolver>, ResolverError<'_>> {
...
async fn create_resolvers(server: &String) -> Result<TokioAsyncResolver, ResolverError<'_>> {
